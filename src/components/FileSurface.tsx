...
// (fit / 100% / ⌘±-and-pinch zoom with scroll-pan), pdf, spreadsheets (xlsx/csv
// → EDITABLE grid when the root is writable, a read-only table otherwise),
...
const TEXT = new Set(["txt", "text", "log", "json", "md", "markdown", "yaml", "yml", "xml", "vtt", "srt", "rtf"]);
      ...
      <div
        ...
        className={
          kind === "sheet" && !tooLarge
            ...
            : kind === "image" || kind === "pdf" || kind === "other" || (kind === "html" && htmlMode === "preview" && !tooLarge)
