    ...
    rail.innerHTML = `
      <div class="chat-work-panel">
        ...
        <div class="chat-work-list">
          <button class="chat-work-row"><span class="chat-work-thumb"></span><span class="chat-work-copy"><span class="chat-work-name">architecture.png</span><span class="chat-work-meta">Image · Attached</span></span></button>
        </div>
      </div>
