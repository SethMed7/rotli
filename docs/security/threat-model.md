...
| A malicious document/board exploits a codec or exhausts resources | Vendor code behind adapters, package preservation tests, parity-pinned Excalidraw byte/element/action/string/coordinate/depth limits, dependency audit | Complex third-party parsers retain supply-chain and parser risk |
