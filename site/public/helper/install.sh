...
#
# ROTLI_HELPER_VERSION=1.0.0 overrides the version; ROTLI_HELPER_DRY_RUN=1
# prints what would be downloaded and stops.
set -eu

VERSION="${ROTLI_HELPER_VERSION:-1.0.0}"
...
# Verify when the release ships checksums and this machine can compute one.
